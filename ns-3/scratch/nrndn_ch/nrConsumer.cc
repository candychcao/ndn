...
void nrConsumer::StartApplication()
{
	...
	std::cout<<"siu:"<<"Start consumer Application: " << GetNode ()->GetId ()<<endl;
}
...
void nrConsumer::StopApplication()
{
	...
	std::cout<<"siu:"<<"stop consumer Application: " << GetNode ()->GetId ()<<endl;
}
...
void nrConsumer::OnData(Ptr<const Data> data)
{
	...
	//cout<<"packetPayloadSize"<<packetPayloadSize<<endl;
